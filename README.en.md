...
Small, direct tasks use a lightweight path. Large, mixed-source tasks or formal predictive and causal claims use the fuller evidence and review path only when needed.
...
The screenshots below use fully synthetic data. They show report presentation and contain no real business information.

### Conclusions first, evidence next

![Data Lens synthetic business report overview](docs/images/data-lens-report-desktop.png)

### Every finding keeps alternatives and limits
